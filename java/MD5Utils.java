...
public class MD5Utils {
    ...
    public static String getMD5(String source)
    {
        ...
        return changeHex(md5.Atemp)+changeHex(md5.Btemp)+changeHex(md5.Ctemp)+changeHex(md5.Dtemp);
    }
     ...
     * 获取MD5，32位大写
     */
    public static String getMD5_up(String source)
    {
        String md5 = getMD5(source);
     ...
     * 获取MD5，16位大写
     */
    public static String getMD5_up_16(String source)
    {
        String md5 = getMD5_16(source);
        return md5.toUpperCase();
    }
